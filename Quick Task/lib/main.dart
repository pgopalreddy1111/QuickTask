...
void main() async {
  ...
  final keyApplicationId = 'XAq0PZASMaDcQ0RzTM3IhCpjrLpzQzskxL0QcikH';
  final keyClientKey = 'lgALAUzbsXjjfhMxUvLNsIj5OSpMuG0rUlGjd9iO';
...
class _EditTaskScreenState extends State<EditTaskScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Task', style:
...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Task', style:
              TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 180, 215, 244))),
        backgroundColor: Colors.lightBlueAccent,
        centerTitle: true
      ),
